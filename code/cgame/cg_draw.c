...
void CG_DrawFlagStatus()
{
	...
	{
		CG_DrawPic( startDrawPos, cgDC.screenHeight-115, ico_size, ico_size, theirFlagShader );
		startDrawPos += ico_size+2;
	}

	if (CG_OtherTeamHasFlag())
	{
		CG_DrawPic( startDrawPos, cgDC.screenHeight-115, ico_size, ico_size, myFlagTakenShader );
	}
}

...
#define MVSDK_CGFLAG_SUBMODEL_TIME2         (1 << 1)        // Set by the client in mvsdk_cgFlags to inform the server that it is capable of reading modelindexes >= 255 from time2 when the modelindex is set to 255
